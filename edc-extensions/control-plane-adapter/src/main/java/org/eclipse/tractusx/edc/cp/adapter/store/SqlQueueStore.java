...
public class SqlQueueStore extends AbstractSqlStore {
    ...
    public SqlQueueStore(DataSourceRegistry dataSourceRegistry, String dataSourceName, TransactionContext transactionContext, ObjectMapper objectMapper, QueueStatements statements, String connectorId, Clock clock) {
