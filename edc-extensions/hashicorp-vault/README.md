...
| edc.vault.hashicorp.secret.data.path | Path to the secret data endpoint (default: _/v1/secret/data_) |
| edc.vault.hashicorp.secret.metadata.path | Path to the secret metadata endpoint (default: _/v1/secret/metadata_) |
