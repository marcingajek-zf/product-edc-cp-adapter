...
import static net.catenax.edc.hashicorpvault.HashicorpVaultExtension.VAULT_NAMESPACE;
...
class HashicorpVaultNamespacedIT extends AbstractHashicorpIT {

  @Override
  protected Map<String, String> getConfig() {
    Map<String, String> config = new HashMap<>(super.getConfig());

    config.put(VAULT_NAMESPACE, "my/test/namespace");
