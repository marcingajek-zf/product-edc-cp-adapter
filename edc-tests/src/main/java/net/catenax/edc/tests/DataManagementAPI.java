...
public class DataManagementAPI {
    ...
    public ContractDefinition getContractDefinition(String id) throws IOException, ClientProtocolException {
        final DataManagementApiContractDefinition contractDefinition = get(CONTRACT_DEFINITIONS_PATH, id);
    ...
    public Stream<ContractDefinition> getAllContractDefinitions() throws IOException, ClientProtocolException {
        final Stream<DataManagementApiContractDefinition> contractDefinitions = get(CONTRACT_DEFINITIONS_PATH);
    ...
    private Asset mapAsset(DataManagementApiAsset DataManagementApiAsset) {
        ...
        final String description = (String) DataManagementApiAsset.properties
                .get(DataManagementApiAsset.DESCRIPTION);
    ...
    private ContractDefinition mapContractDefinition(
        ...
        final List<String> assetIds = dataManagementContractDefinition.selectorExpression.getCriteria()
                .stream()
